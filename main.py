...
state_rep = State_Rep(c, h, w, attn_heads = 2, gru_layers = 1).to(device)
...
train(env, state_rep, policy, value_fn, policy_optim, value_fn_optim, episodes = episodes, gamma = gamma, k1 = 2, k2 = 3)
